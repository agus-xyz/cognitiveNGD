...
#define __STACK_TSK_H
    ...
    #include "TCPIP Stack/WF_Config.h"
#endif

// Check for potential configuration errors in "TCPIPConfig MRF24WB0M.h"
...
typedef struct __attribute__((__packed__)) appConfigStruct {
    ...
    MAC_ADDR MyMACAddr;             // Application MAC address
        ...
        BYTE SecurityMode;           // WF_SECURITY_OPEN or other security mode
