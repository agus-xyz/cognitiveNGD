...
/*--------------------------------------------*/
#define MY_DEFAULT_SSID_NAME        "LSI_CWSN"      //Orig: "MicrochipDemoAP"
#define MY_DEFAULT_NETWORK_TYPE     WF_ADHOC        // Or WF_INFRASTRUCTURE
#define MY_DEFAULT_SCAN_TYPE        WF_ACTIVE_SCAN  // Or WF_PASSIVE_SCAN
#define MY_DEFAULT_CHANNEL_LIST     {}      // Channels separated by commas
                                            // Use {} to scan all channels
#define ADHOC_RETRY_COUNT                   (3) //Juan - added.
#define INFRASTRUCTURE_RETRY_COUNT          (3) //Juan - added.
...
#define MY_DEFAULT_PS_POLL                  WF_DISABLED         // Or WF_ENABLED
#define MY_DEFAULT_WIFI_SECURITY_MODE       WF_SECURITY_OPEN    // See all below
...
//   WF_SECURITY_WPA_WITH_KEY              : WPA-PSK Personal where binary key
//                                           is given to MRF24WB0M
//   WF_SECURITY_WPA_WITH_PASS_PHRASE      : WPA-PSK Personal where passphrase
//                                           is given to MRF24WB0M and it
//                                           calculates the binary key
//   WF_SECURITY_WPA2_WITH_KEY             : WPA2-PSK Personal where binary key
//                                           is given to MRF24WB0M
//   WF_SECURITY_WPA2_WITH_PASS_PHRASE     : WPA2-PSK Personal where passphrase
//                                           is given to MRF24WB0M and it
//                                           calculates the binary key
//   WF_SECURITY_WPA_AUTO_WITH_KEY         : WPA-PSK Personal/WPA2-PSK Personal
//                                           where binary key is given and
//                                           MRF24WB0M will connect at highest
//                                           level AP supports (WPA or WPA2)
//   WF_SECURITY_WPA_AUTO_WITH_PASS_PHRASE : WPA-PSK Personal or WPA2-PSK
//                                           Personal where passphrase is given
//                                           to MRF24WB0M and it calculates the
//                                           binary key and connects at highest
//                                           level AP supports (WPA or WPA2)

// Default pass phrase used for WF_SECURITY_WPA_WITH_PASS_PHRASE and 
// WF_SECURITY_WPA2_WITH_PASS_PHRASE security modes
#define MY_DEFAULT_PSK_PHRASE               "ext3=0; jfs++; reiser++; /autotest"
// LSI-B105 WiFi passwd

// If using security mode WF_SECURITY_WPA_WITH_KEY or WF_SECURITY_WPA2_WITH_KEY,
// then this section must be set to match the key for MY_DEFAULT_SSID_NAME and
// MY_DEFAULT_PSK_PHRASE combination. The values below are derived from the SSID
// "MicrochipDemoAP" and the pass phrase "Microchip 802.11 Secret PSK Password".
// The tool at http://www.wireshark.org/tools/wpa-psk.html can be used to
// generate this field.
#define MY_DEFAULT_PSK "\
\xB4\x28\x99\x47\x8D\x58\x54\x0C\
\x66\x6D\xA5\x03\x84\x89\x71\x90\
\xFE\xC4\xF8\xCD\xDB\x70\x89\xB6\
\x72\x94\x23\x92\x65\x40\x16\x98"

//"\ //FERNANDO, LA ORIGINAL
...
//------------------------------------------------------------------------------
// Default WEP keys used in WF_SECURITY_WEP_40 and WF_SECURITY_WEP_104 modes
//------------------------------------------------------------------------------
