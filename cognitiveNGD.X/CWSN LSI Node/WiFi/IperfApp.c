...
#if defined (WF_CONSOLE)    //#endif at the end of the file

#include "IperfApp.h"
#include "TCPIP Stack/WFConsole.h"
#include "TCPIPConfig MRF24WB0M.h"      //Juan. Some important definitions.
#include "TCPIP Stack/TCP.h"            //Juan. Needed to use TCP_SOCKET
#include "TCPIP Stack/UDP.h"            //Juan. Needed to use UDP_SOCKET
