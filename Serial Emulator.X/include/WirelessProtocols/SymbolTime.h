...
/************************ DEFINITIONS ******************************/
    ...
    //XXX-Willy. Modificacion del codigo puesto que por defecto da por supuesto
    //que el PBDIV está a DIV_4.
//    #define INSTR_FREQ  (CLOCK_FREQ/4) //XXX-Original.
    #define WillyPBDIV   4   //XXX-Willy. Cambiar según lo hayamos configurado.
    #define INSTR_FREQ  (CLOCK_FREQ/WillyPBDIV)  //XXX-Willy. Para que se adapte a lo
    ...
    #define TICKS_PER_SECOND (INSTR_FREQ/CLOCK_DIVIDER)//XXX-Willy

//    #define ONE_SECOND (((DWORD)INSTR_FREQ/1000 * 62500) / (SYMBOL_TO_TICK_RATE / 1000))//XXX-Willy. Original.
    //XXX-Willy. Lo vamos a dejar igual pero en vez de 62500 ponemos el numero de ticks que nos sale con nuestra
    //frecuencia, PBDIV y divisor. Como instr_freq y Symbol_to_tick son iguales, se van y no influyen. Se podría
    //hacer adaptando el symbol_to_tick_rate a las condiciones particulares mencionadas y así podríamos no cambiar
    //el 62500 pero sigue siendo igual de absurdo. Esto es pregunta de foro.
