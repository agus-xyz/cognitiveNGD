        ...
        BOOL MiMAC_MRF49XA_PowerState(INPUT BYTE PowerState, INPUT BYTE MRF49XAnum){
            ...
            switch(PowerState){
                ...
                case POWER_STATE_OPERATE:
                    //ORIGINAL: MRF49XA_RegisterSet((PMCREG | 0x0008), MRF49XAnum); // switch on oscillator
                    MRF49XA_RegisterSet((PMCREG | 0x0088), MRF49XAnum); // switch on oscillator AND RECEIVER
