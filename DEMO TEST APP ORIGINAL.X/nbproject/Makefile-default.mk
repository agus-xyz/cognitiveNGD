...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/DEMO_TEST_APP_ORIGINAL.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/DEMO_TEST_APP_ORIGINAL.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/CWSN\ LSI\ Node/Common/TimeDelay.o: CWSN\ LSI\ Node/Common/TimeDelay.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/CWSN\ LSI\ Node/Common 
	@${RM} ${OBJECTDIR}/CWSN\ LSI\ Node/Common/TimeDelay.o.d 
	@${FIXDEPS} "${OBJECTDIR}/CWSN LSI Node/Common/TimeDelay.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"/home/agus/pfc/code/cognitiveNGD/DEMO TEST APP ORIGINAL.X/CWSN LSI Node/Include" -I"/home/agus/pfc/code/cognitiveNGD/libs/Microchip/Include" -MMD -MF "${OBJECTDIR}/CWSN LSI Node/Common/TimeDelay.o.d" -o "${OBJECTDIR}/CWSN LSI Node/Common/TimeDelay.o" "CWSN LSI Node/Common/TimeDelay.c"   
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/DEMO_TEST_APP_ORIGINAL.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_ICD3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/DEMO_TEST_APP_ORIGINAL.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1
else
dist/${CND_CONF}/${IMAGE_TYPE}/DEMO_TEST_APP_ORIGINAL.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/DEMO_TEST_APP_ORIGINAL.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
	${MP_CC_DIR}/xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/DEMO_TEST_APP_ORIGINAL.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
