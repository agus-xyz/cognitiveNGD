...
void* CRM_Disc_Mssg_Rcvd(DISC_MSSG_RCVD *Peticion)
{
    ...
    {
        case(ActSignDetc):
//            *((BYTE*)resultado) = CRM_Disc_SignalDetection(Peticion);
...
BYTE CRM_Disc_SignalDetection(DISC_MSSG_RCVD *Peticion)
{
    ...
    BYTE BackupCurrentChannel = currentChannel;
    CanalMenosRuidoso = MiApp_NoiseDetection(*((DWORD*)(Peticion->Param1)), *((BYTE*)(Peticion->Param2)), *((BYTE*)(Peticion->Param3)), ((BYTE*)(Peticion->Param4)));
    MiApp_SetChannel(BackupCurrentChannel);
