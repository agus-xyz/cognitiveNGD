...
//#if defined(TEST6)
            ...
            if(OptmEstado == WaitinAnsw4ChngChn)
            {
                ...
                {
                    if(Peticion->EUINodo[MY_ADDRESS_LENGTH - i - 1] < myLongAddress[MY_ADDRESS_LENGTH - i -1])
                    {
                        break;
                    }
                }
...
//                REPO_MSSG_RCVD PeticionProb;
            ...
            Printf("Respuesta recibida al cambio de canal ...");
                ...
                IndiceTabla = GuilJa_MiWi_Search4ShorAddrss( Peticion->EUINodo, Repo_Conn_Table);
                ...
                PeticionProb.Param2 = &IndiceTabla;
                PeticionProb.Param3 = &PeticionesEnviadasProv;
                PeticionProb.Param4 = &PeticionesAceptadasProv;
...
//                            ConnectionTable[i].status.bits.isValid = 0;
                ...
                PeticionActualProb.Param2 = &IndiceTabla;
