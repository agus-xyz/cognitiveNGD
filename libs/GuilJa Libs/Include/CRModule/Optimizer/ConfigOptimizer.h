...
#endif
#if defined TEST6
#define TIEMPODEESPERARESPUESTA 2000
#endif

//Cada cuanto queremos que se ejecute la rutina de optimizacion.
#define PeriodoXDefecto 10000 //En mseg => Cada 30 segundos.
...
#else
    #define maxRTxXDefecto 0 //TODO el MRF24J40 no tiene por defecto rtx, hay que
