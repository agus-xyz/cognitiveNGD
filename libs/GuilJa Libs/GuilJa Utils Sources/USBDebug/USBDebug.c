/*****************************************************************************
 *
 *                       USBDebug.c -- USBDebug v0.1
 *
 *****************************************************************************
 *
 * Author:          Guillermo Jara Luengos
 * FileName:        USBDebug.c
 * Dependencies:    USBDebug.h, usb_descriptors.h, usb_function_cdc.h,
 *                  usb_device.h, usb.h
 * Processor:
 * BOARD:
...
#include "GuilJa Utils Heads/USBDebug/USBDebug.h"


/** CONFIGURATION **************************************************/
//XXX-Willy. La configuración de la placa  estará en el HardwareProfile
/** I N C L U D E S **********************************************************/
...
BOOL B105_USB_Initialized; //XXX_Willy.
...
/********************************************************************
 * Function:        static void B105_InitializeSystem(void)
 *
 * PreCondition:    None
 *
 * Input:           None
...
{
    #if defined(__C32__)
//        AD1PCFG = 0xFFFF;//XXX-Willy. Ya esta inicializado en el BoardInit de
    //del HardwareProfile.c
    #endif
